...
import meldsun0.utp.algo.MinimumDelay;
...
public class MinDelayTest {
  ...
  /** Tests the min delay, when its outdated, it should be updated to the most recent. */
  @Test
  public void testMinDelayOutdated() {
    ...
    delay.updateOurDelay(5, 3);
    delay.updateOurDelay(8, 12);
    // new minimum should be 20, with timestamp MinimumDelay.MINIMUM_DIFFERENCE_TIMESTAMP_MICROSEC +
    // x | x >= 2;
