package meldsun0.utp.data.bytes;

import meldsun0.utp.data.bytes.exceptions.ByteOverflowException;
import meldsun0.utp.data.bytes.exceptions.SignedNumberException;

/**
 * Workaround to java's lack of unsigned types. Methods provided here intend to return integers,
 * bytes and shorts which can be interpreted as unsigned types. E.G. Java's byte initialized with
 * 0xFF will correspond to -1, with this workaround we can use more readable decimal value of 255 to
 * convert it to -1, which in binary form is 11111111 and interpreted as an unsigned value, it would
 * be 255.
 *
