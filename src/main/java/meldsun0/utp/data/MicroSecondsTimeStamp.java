 ...
 * the License.
 */
package meldsun0.utp.data;

import meldsun0.utp.data.bytes.UnsignedTypesUtil;
import meldsun0.utp.data.bytes.exceptions.ByteOverflowException;

import static meldsun0.utp.data.bytes.UnsignedTypesUtil.MAX_UINT;
import static meldsun0.utp.data.bytes.UnsignedTypesUtil.longToUint;
